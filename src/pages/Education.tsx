         ...
         <div ref={headerRef} className="bg-slate-900 text-white py-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
               <div className="text-center max-w-4xl mx-auto">
                  <h1 className="education-header-content text-4xl md:text-5xl font-bold mb-6">
                     <TextReveal>Образовательные программы</TextReveal>
                  </h1>
                  <p className="education-header-content text-xl text-slate-300 leading-relaxed">
                     Повышаем грамотность предпринимателей и помогаем избегать ошибок на старте
                  </p>
               </div>
            </div>
         </div>
               ...
               <RevealOnScroll direction="right" delay={0.2}>
                  <div>
                     <h3 className="text-2xl font-bold text-slate-900 mb-4">
                        <TextReveal>Для кого наши курсы?</TextReveal>
                     </h3>
                     <StaggerReveal staggerDelay={0.1} childClassName="course-item">
                        <ul className="space-y-4">
                           <li className="course-item flex gap-3">
