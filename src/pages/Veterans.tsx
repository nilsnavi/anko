...
const Veterans: React.FC = () => {
   ...
   return (
      <div>
         {/* Hero for Veterans with GSAP */}
         <div ref={heroRef} className="bg-slate-900 text-white py-20 relative overflow-hidden">
            <AnimatedCircles count={4} />
            <div className="container mx-auto px-4 text-center max-w-4xl relative z-10">
               <div className="veterans-hero-content inline-flex items-center gap-2 bg-brand-900 border border-brand-700 rounded-full px-4 py-1 mb-6">
                  <Shield size={16} className="text-brand-400" />
                  <span className="text-sm font-semibold uppercase tracking-wide">Специальная программа</span>
               </div>
               <h1 className="veterans-hero-content text-3xl md:text-5xl font-bold mb-6">
                  <TextReveal>Поддержка ветеранов боевых действий</TextReveal>
               </h1>
               <p className="veterans-hero-content text-xl text-slate-300 leading-relaxed">
         ...
         <Section>
            <StaggerReveal className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16" staggerDelay={0.15} childClassName="veteran-card">
               <ScaleReveal>
                  <div className="veteran-card bg-white p-8 rounded-xl shadow-lg border-t-4 border-brand-600 hover:-translate-y-1 transition-transform">
            ...
            <div className="bg-slate-50 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row gap-12 items-center">
               <RevealOnScroll direction="left" className="md:w-1/2">
                  <div>
                     <h2 className="text-3xl font-bold text-slate-900 mb-6">
                        <TextReveal>Как получить поддержку?</TextReveal>
                     </h2>
                     <StaggerReveal staggerDelay={0.15} childClassName="step-item">
                        <ol className="space-y-6">
                           <li className="step-item flex gap-4">
               ...
               <RevealOnScroll direction="right" delay={0.2} className="md:w-1/2">
                  <div className="bg-white p-8 rounded-xl shadow-md w-full relative overflow-hidden">
                     {isSubmitted ? (
