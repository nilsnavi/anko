...
import { Edit2, Save, X, Trash2, Plus, Search, ChevronLeft, ChevronRight, Check, Ban } from 'lucide-react';
                    ...
                    <>
                      ...
                      <td className="py-4 px-6">
                        <button
                          ...
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium transition-colors ${client.status === 'active'
